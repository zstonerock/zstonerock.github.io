...
var watchSrc = ['**/*.html', 'assets/**/*', '!assets/*.js', '!assets/*.css', 'layout/**/*.*', 'snippets/**/*.*', 'sections/**/*.*', 'templates/**/*.*'];
...
gulp.task('default', ['git_check','js:hint','js:concat','css:postsass'], function() {
	...
	gulp.watch("*.html").on('change', function() {
		return gulp.src('**/*.html')
			...
			.pipe(notify({ title: clientName + ' HTML', message: 'HTML Refreshed' }));
	});
});